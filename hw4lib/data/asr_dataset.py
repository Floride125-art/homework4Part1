...
class ASRDataset(Dataset):
    def __init__(
        ...
        # The root is defined in the config file
        ...
        # TODO: Take subset
        # The subset size is defined in the config file
