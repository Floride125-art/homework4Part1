...
class SequenceGenerator:
    ...
    def generate_greedy(
        ...
        # Get the highest probability tokens and corresponding scores
          next_token_scores, next_tokens = log_probs.max(dim=-1)
        ...
        # Update finished flags if EOS token is generated
